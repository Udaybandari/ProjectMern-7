  ...
  return (
    <div className="user-card p-2">
        <div className="flex items-center justify-between">
           ...
           <img src={userInfo.profileImageUrl || null}  alt={`Avatar`} className="w-12 h-12 rounded-full border-2 border-white" />
            <div>
...
const StatCard=({label,count,status})=>{
  ...
  return(
    <div className={`flex-1 text-[10px] font-semibold ${getStatusTagColor()} px-4 py-0.5 rounded`}>
