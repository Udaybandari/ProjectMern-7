...
const updateTodoChecklist = async (index) => {
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      // Revert toggle if API did not succeed
          ...
          task&&(
            ...
            <div className="form-card col-span-3">
              <div className="flex items-center justify-between">
                ...
                <div className={
                  `text-[13px] font-medium ${getStatusTagColor(
                    task?.status
                  )} px-4 py-0.5 rounded`
                }>
                  {task?.status}
...
const Attachment=({link,index,onCLick})=>{
  return <div className="flex justify-between  border bg-gray-50 border border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer"> 
